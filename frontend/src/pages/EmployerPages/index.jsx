...
const mainMenus = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: SECTIONS.EVALUATION, label: "Đánh giá", icon: <PersonSearchOutlinedIcon fontSize="small" /> },
    ],
  },
  {
      ...
      <StyledMainContent>
        <Box sx={{ p: 3 }}>
          ...
          <Box sx={{ mt: 2 }}>
            ...
            {selectedSection === SECTIONS.FIND_EMPLOYEE && <h2>Tìm ứng viên</h2>}
            {selectedSection === SECTIONS.EVALUATION && <EvaluationDashboard />}
